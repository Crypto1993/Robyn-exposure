...
robyn_inputs <- function(dt_input = NULL,
                         ...
                         paid_media_lower_bounds = NULL,
                         paid_media_upper_bounds = NULL,
                         organic_vars = NULL,
                         organic_signs = NULL,
                         organic_lower_bounds = NULL,
                         organic_upper_bounds = NULL,
                         context_vars = NULL,
                         context_signs = NULL,
                         context_lower_bounds = NULL,
                         context_upper_bounds = NULL,
                         factor_vars = NULL,
                         dt_holidays = Robyn::dt_prophet_holidays,
                         prophet_vars = NULL,
                         prophet_signs = NULL,
                         prophet_lower_bounds = NULL,
                         prophet_upper_bounds = NULL,
  ...
  if (is.null(InputCollect)) {
    ...
    InputCollect <- list(
      ...
      prophet_lower_bounds = prophet_lower_bounds,
      prophet_upper_bounds = prophet_upper_bounds,
      prophet_country = prophet_country,
      context_vars = context_vars,
      context_signs = context_signs,
      context_lower_bounds = context_lower_bounds,
      context_upper_bounds = context_upper_bounds,
      paid_media_vars = paid_media_vars,
      paid_media_signs = paid_media_signs,
      paid_media_lower_bounds = paid_media_lower_bounds,
      paid_media_upper_bounds = paid_media_upper_bounds,
      paid_media_spends = paid_media_spends,
      mediaVarCount = mediaVarCount,
      exposure_vars = exposure_vars,
      organic_vars = organic_vars,
      organic_signs = organic_signs,
      organic_lower_bounds = organic_lower_bounds,
      organic_upper_bounds = organic_upper_bounds,
      all_media = all_media,
